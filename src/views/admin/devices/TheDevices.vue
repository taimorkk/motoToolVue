<template>
    <div class="user-data">
       <div class="card">
  <h5 class="card-header text-white w-70  bg-primary">Device History</h5>
  <div  class="card-body ">
      <button v-if="isAdmin" @click="loadData" class="btn btn-primary">Refresh Data</button>
<button v-if="isAdmin" class="btn  btn-info m-3 float-end"  data-bs-toggle="modal" data-bs-target="#userModal"><i class="fa fa-plus"></i> Device</button>
